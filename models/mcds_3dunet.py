...
class DenoisingBlock(nn.Module):
    ...
    def forward(self, encoder_layer, decoder_layer):
        ...
        cropped_encoder_layer, dec_layer = (encoder_layer, up_layer)  # cropping
...
class MCDSUnet(nn.Module):
    def __init__(self,
        ...
        self.out_channels_denoise = out_channels_denoise
        self.out_channels_segment = cfg.out_channels
        self.n_blocks = cfg.n_blocks
        self.start_filters = cfg.start_filters
        self.activation = activation
        self.normalization = normalization

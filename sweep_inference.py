...
for fold in range(cfg.n_folds):
    ...
    cfg.val_tomograms = cfg.test_tomograms = [cfg.all_tomograms[fold]]
    ...
    for i in range(24, 154, 5):
        print("EPOCH: ", i)
        #weights = f'logs/checkpoints/CRYOET-269/epoch_129_fold{fold}.pth'
        weights = f'logs/checkpoints/CRYOET-347/epoch_{i}_fold{fold}.pth'

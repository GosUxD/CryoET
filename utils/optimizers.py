...
class Lookahead(Optimizer):
    ...
    def __init__(self, optimizer,alpha=0.5, k=6,pullback_momentum="none"):
        ...
        super().__init__(param_groups, self.optimizer.defaults)
...
# Example usage
# averaged_weights = amalgamate_models("my_experiment", epoch=10, n_folds=7)
# torch.save(averaged_weights, "averaged_model_weights.pth")

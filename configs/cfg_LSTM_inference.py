...
cfg.n_folds = len(cfg.all_tomograms)
...
cfg.random_block_prob = 0.3

### MODEL PARAMETERS
cfg.model = 'rcnn' #'debug'
cfg.nms_kernel = 5
cfg.in_channels = 1
cfg.out_channels = cfg.num_classes
#cfg.feature_maps = [32, 64, 96, 144]
...
cfg.pad_size = 15
cfg.discard_range = 6
print("PAD SIZE:", cfg.pad_size, " DISCARD RANGE:", cfg.discard_range)
